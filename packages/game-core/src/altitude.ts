...
export const ALTITUDE_EVENTS = [
  { at:30*60, duration:420, peak:4.2, kind:'updraft' },
  { at:93*60, duration:420, peak:5, kind:'jetstream' },
  { at:144*60, duration:480, peak:4.8, kind:'boss-wave' },
] as const
export const BOSS_ENCOUNTERS = [
  { at:60*60, kind:'sentinel', name:'CROWN OF THE DEEP', hp:280, reward:450, salvage:4 },
  { at:144*60, kind:'guardian', name:'STORMWYRM SOVEREIGN', hp:420, reward:1000, salvage:6 },
] as const
