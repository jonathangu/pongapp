...
export function crossingObjective(state: RescueState, captain: boolean) {
  ...
  if (step === 0) return { title: '1 · Get a feel for the helm', body: captain ? 'Drag the round joystick a little. Release it to brake. Finn is safe; enemy fire cannot hurt your ship during practice.' : 'Your captain is learning to steer. Tap Cannons to lend a hand; your character walks there automatically.', job: captain ? 'Helm' : 'Cannons' }
