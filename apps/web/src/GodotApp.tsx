...
export default function GodotApp() {
  ...
  return <>{song.audio}{options ? <GodotGame options={options} onExit={home} song={song}/> : <div className="crossing-home">
    ...
    <main className="crossing-main"><section className="crossing-intro"><p className="g-eyebrow">A LITTLE BOAT. A WORLD WORTH BRAVING.</p><h1>Bring each<br/>other <em>home.</em></h1><p>A complete adventure for one.<br/>A crossing you can share with someone.<br/>From the sea to unwritten stars.</p></section>
      <section className="crossing-board" aria-label="Start your voyage"><p className="crossing-tag">SOLO OR TOGETHER · PORTRAIT · NO ACCOUNT</p>
        <h2>{ready ? 'All aboard?' : 'Your boat is waiting.'}</h2><p className="crossing-explain">You steer. Finn has your back.<br/>Rescue lost crews. Choose what your family carries.</p>
